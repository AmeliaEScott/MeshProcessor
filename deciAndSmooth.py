...
MESHLAB_SCRIPT = 'test.mlx' # Name of original meshlab script
...
MIN_DECIMATION = 0.3 # Minimum value of 'TargetPerc' parameter for decimation (for very large number of faces)
